...
import RelatedDocdors from "../component/RelatedDocdors";
  ...
  const getAvailableSlot = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      while (currentDate < endTime) {
        ...
        // increment current tym by 30min
    ...
    docInfo && (
      <div>
        ...
        <div className="sm:ml-72 sm:pl-4 font-medium text-gray-700">
          <p>Booking slot</p>
          <div className="flex gap-3 items-center w-full overlow-x-scroll mt-4">
            {docSlots.length &&
        ...
        {/*related doc   */}
        <RelatedDocdors docId={docId} speciality={docInfo.speciality} />
      </div>
    )
  );
};
