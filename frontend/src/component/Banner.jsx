  ...
  return (
    <div className="flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10">
      ...
      <div className="flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5">
        <div className="text-xl sm:text:text-2x1 md:text-3xl lg:text-5xl font-semibold text-white">
      ...
      {/* right side */}
      <div className=" md:border-l-orange-50 md:w-1/2 lg:w-[370px] relative">
